...
export const ScoreScreen = ({ score, totalQuestions, resetGame }) => (
    <div className="text-center space-y-8 min-h-[400px] flex flex-col justify-center items-center p-6 bg-gray-900 rounded-sm shadow-lg border border-gray-700 text-white">
        <h2 className="text-4xl font-extrabold text-white border-b border-gray-700 pb-2 mb-4">GAME ENDED</h2>
        
        <div className="bg-gray-800 p-8 rounded-xl border border-gray-700">
            <p className="text-3xl text-gray-200">Your Total Score:</p>
            <p className="text-7xl font-extrabold my-4 text-emerald-500">
                {score} <span className="text-4xl text-gray-400">POINTS</span>
            </p>
        ...
        <ConsoleButton onClick={resetGame} className="w-2/3 text-xl">
