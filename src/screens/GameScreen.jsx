    ...
    return (
        <div className="space-y-10 text-white"> 
            ...
            <div className="bg-gray-800 p-6 rounded-sm border border-gray-700">
                <p className="text-left text-base font-medium  md:text-2xl text-white leading-normal">{question}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {options.map((option, index) => (
                    <button
                        ...
                        className={`py-3 px-4 text-left md:text-lg rounded-sm border-2 transition duration-300 break-words
